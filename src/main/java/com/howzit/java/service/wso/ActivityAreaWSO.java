...
public class ActivityAreaWSO {
    ...
    private CategoryWSO category;
    private Long categoryId;
    private Long createdById;
    private Integer type;
    private List<ActivityWSO> activityList;
    private Map<String, String> statistic = new HashMap<String, String>();

    public ActivityAreaWSO() {
    }

    public ActivityAreaWSO(ActivityAreaEntity activityArea) {
        ...
        this.category = new CategoryWSO(activityArea.getCategory(), false);
        ...
        if (null != activityArea.getActivityList()) {
            this.activityList = new ArrayList<ActivityWSO>();
            for (ActivityEntity activity : activityArea.getActivityList()) {
                this.activityList.add(new ActivityWSO(activity, true));
            }
        }
    }
    ...
    public CategoryWSO getCategory() {
        return category;
    }

    public void setCategory(CategoryWSO category) {
    ...
    public List<ActivityWSO> getActivityList() {
        return activityList;
    }

    public void setActivityList(List<ActivityWSO> activityList) {
